const blockwrite = (writer:any,key:string,value:any,ambiuious:string[]=[],quote:string[]=[]) => {
...
const justwrite = (writer:any,text:{[key:string]:any},ambiuious:string[]=[],quote:string[]=[]) => {
    for (let key in text){

...
const gethexname = (r:number,g:number,b:number) => "x" + (r.toString(16).padStart(2, '0') + g.toString(16).padStart(2, '0') + b.toString(16).padStart(2, '0')).toUpperCase()

const select_states = (imgdata:ImageData,reset_data:ImageData,x:number,y:number,state_name:Set<number>,e:MouseEvent) => {
...
const select_states_color = (sindex:number,imgdata:ImageData) => {
...
const muti_selection = (provs_name:Set<string>,start_x:number,start_y:number,end_x:number,end_y:number,e:MouseEvent) => {
...
const select_prov_pure = (imgdata:ImageData,state_data:ImageData,label:string,sindex:number,provs_name:Set<string>,e:MouseEvent) => {
...
const select_provs = (imgdata:ImageData,state_data:ImageData,label:string,sindex:number,provs_name:Set<string>,e:MouseEvent) => {
    console.log(provs_name)
...
const select_provs_color = (hexname:string,imgdata:ImageData) => {
...
const canvas_reset = (imgdata:ImageData,reset_data:ImageData) => {

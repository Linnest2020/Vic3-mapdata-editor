...
let mode = "detail"
let state_edit_mode_selection = document.getElementById("state_edit_mode_selection")
...
const state_detail_edit = (info) => {
    ...
    state_public.querySelector("button").addEventListener("click",function(e){state_public.appendChild(draw_state_detail("","",state_detail,false))})
    state_private.querySelector("button").addEventListener("click",function(e){state_private.appendChild(draw_state_detail("","",state_split_detail,false))})
...
const draw_state_detail = (key,value,data,disabled=true) => {
    ...
    plus.onclick = function(e) {
        ...
        dom.parentNode.appendChild(draw_state_detail("","",data,false))
    }
...
const state_pops_edit = (info) => {
    ...
    state_private.querySelector("button").addEventListener("click",function(e){state_private.appendChild(draw_pop_detail("","","",pop_detail,"",false))})
...
const draw_pop_detail = (cu,religion,size,data,pop_type,disabled=true) => {
    let dom = document.createElement("div")
    let minus = btn_adjustment("-")
    dom.appendChild(minus)
    ...
    plus.onclick = function(e) {
        ...
        dom.parentNode.appendChild(draw_pop_detail("","","",data,"",false))
    }
...
const state_building_edit = (info) => {
    ...
    state_private.querySelector("button").addEventListener("click",function(e){state_private.appendChild(draw_building_detail("","","",[],building_detail,false))})
    if (state_public.classList.contains("state_property_flow")) state_public.classList.remove("state_property_flow")
    if (!state_private.classList.contains("state_property_flow")) state_private.classList.add("state_property_flow")
...
const draw_building_detail = (key,lv,re,pm,data,disabled=true) => {
    let is_more = false
        ...
        if (data["create_building"] instanceof Array){
            for (let i=0;i<data["create_building"].length;i++){
                ...
                if (data["create_building"][i]["building"] == key_input.value){
                    ...
                    dom.parentNode.appendChild(draw_building_detail("","","",data["create_building"][i],data,false))
                    return
                }
            }
        } else{
            data["create_building"] = [arr]
            dom.parentNode.appendChild(draw_building_detail("","","",data["create_building"][0],data,false))
        }

        if (push){
            data["create_building"].push(arr)
            let length =data["create_building"].length -1
            dom.parentNode.appendChild(draw_building_detail("","","",data["create_building"][length],data,false))
        }
    ...
    more.onclick = function(e) {
        ...
        more_info.querySelector("button").addEventListener("click",function(e){more_info.appendChild(draw_pm_detail("",pm,"activate_production_methods"))})
...
const draw_pm_detail = (key,data,kw="") => {
    ...
    minus.onclick = function(e) {
        if (!key_input.value){
            if (!key) dom.parentNode.removeChild(dom)
            else return
        }

        data[kw] = data[kw].filter((items,index) => ![key].includes(items))
    ...
    plus.onclick = function(e) {
        ...
        dom.parentNode.appendChild(draw_pm_detail("",data,kw))
    }
...
const draw_kv_detail = (key,value,data) => {
    ...
    plus.onclick = function(e) {
        ...
        dom.parentNode.appendChild(draw_kv_detail("","",data))
    }
...
const state_cresource_edit = (info) => {
    ...
    state_public.querySelector("button").addEventListener("click",function(e){
...
const draw_resource_detail = (key,akey,un,max,data,index) => {
    let dom = document.createElement("div")
    ...
    plus.onclick = function(e) {
        ...
        dom.parentNode.appendChild(draw_resource_detail("","","","",data,-1))
    }
...
const state_resource_edit = (info) => {
    ...
    state_public.querySelector("button").addEventListener("click",function(e){state_public.appendChild(draw_resource_detail("","","","",state_detail,-1))})

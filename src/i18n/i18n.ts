...
document.getElementById("state_panelboard").querySelector("button").innerText =
    localization.start_edit;
...
document.querySelector("option[value=strategic]").innerText =
    localization.strategic;
document.querySelector("option[value=terrain]").innerText =
    localization.terrain;
document.querySelector("option[value=country]").innerText =
...
document.querySelector("option[value=building]").innerText =
    localization.building;
document.querySelector("option[value=aresource]").innerText =
    localization.aresource;
document.querySelector("option[value=cresource]").innerText =
    localization.cresource;
document.querySelector("option[value=resource]").innerText =

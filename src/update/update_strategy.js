...
let strategic_name_input = document.getElementById("strategic_name_input")
let culture_name_input = document.getElementById("culture_name_input")
let capital_name_input = document.getElementById("capital_name_input")

const update_strategy = (state_name) => {
    ...
    for (let i of state_name){
        ...
        for(let j=0,keys=Object.keys(full_map_data.strategic_regions_map),len=keys.length;j<len;j++){
            ...
            if (full_map_data.strategic_regions_map[region]["states"].indexOf(name)>-1 && strategic_name!=region ){
                full_map_data.strategic_regions_map[region]["states"] = full_map_data.strategic_regions_map[region]["states"].filter(item => item!=name)
                break
            }
